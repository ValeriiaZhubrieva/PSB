(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".members-ordinary__slider")) new core(".members-ordinary__slider", {
            modules: [ Scrollbar ],
            observer: true,
            observeParents: true,
            slidesPerView: 4.7,
            ...
            speed: 800,
            scrollbar: {
                el: ".members-ordinary__scrollbar.swiper-scrollbar",
                draggable: true
            },
            breakpoints: {
                320: {
        ...
        if (document.querySelector(".members-supportive__slider")) new core(".members-supportive__slider", {
            modules: [ Scrollbar ],
            observer: true,
            observeParents: true,
            slidesPerView: 4.7,
            ...
            speed: 800,
            scrollbar: {
                el: ".members-supportive__scrollbar.swiper-scrollbar",
                draggable: true
            },
            breakpoints: {
                320: {
    ...
    if (document.documentElement.classList.contains("touch") || window.innerWidth < 768 || window.innerWidth >= 768) {
